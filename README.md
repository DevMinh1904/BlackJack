...
**[Blackjack.apk](https://github.com/DevMinh1904/BlackJack/releases/download/Game/Blackjack.apk)**
...
* **Smooth Animations:** Features card dealing animations for an immersive experience.
...
3.  **Open in Android Studio:**
    ...
    *   Go to **File > Open**.
    *   Select the `BlackJack` folder you just cloned.
4.  **Build and Run:** Let Gradle sync, then press the green **Run** button.
